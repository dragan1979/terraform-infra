...
# This resource tells Azure: "If a pod in the prod namespace of my AKS cluster is using the petclinic-sa service account, trust it, and hand it the tokens for this identity."
resource "azurerm_federated_identity_credential" "petclinic_fic" {
  ...
  subject = "system:serviceaccount:prod:petclinic-sa"
}